      ...
      >
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3 rounded-b-xl">
          ...
          <button
            ...
            className="px-4 py-2 bg-[var(--primary-button-bg)] text-white rounded-lg hover:bg-[var(--primary-button-hover-bg)] font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Convert to Contact
          </button>
        </div>
