...
export const ConnectClusterArgs = {
    ...
    connectionType: AtlasArgs.connectionType().describe("Type of connection (standard, private, or privateEndpoint) to an Atlas cluster"),
};
export class ConnectClusterTool extends AtlasToolBase {
    constructor() {
        super(...arguments);
        this.description = "Connect to MongoDB Atlas cluster";
        this.argsShape = ConnectClusterArgs;
    }
