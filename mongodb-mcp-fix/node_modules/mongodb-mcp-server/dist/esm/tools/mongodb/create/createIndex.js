...
`),
            model: z
                ...
                .describe("Voyage embedding model to use for automatically generating embeddings from the source text in the indexed field."),
            modality: z
                .enum(["text"])
                .describe("The data type / modality of the source content in the indexed field. Currently only 'text' is supported."),
...
`);
        this.vectorSearchIndexDefinition = z
            .object({
...
`),
        ...
        this.atlasSearchIndexDefinition = z
            .object({
            ...
            mappings: z
                ...
                fields: z
                    .record(z.string().describe("The field name"), z
                    .object({
                    type: z
                        .enum([
                        "autocomplete",
            ...
            .describe("Definition for an Atlas Search (lexical) index. Use this only if user explicitly asked for creating an Atlas search index or simply a search index.");
...
CreateIndexTool.toolName = "create-index";
