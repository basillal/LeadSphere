...
export declare abstract class ToolBase {
     ...
     * ```
     */
    protected abstract execute(args: ToolArgs<typeof this.argsShape>, { signal, requestInfo }: ToolExecutionContext): Promise<CallToolResult>;
    /** This is used internally by the server to invoke the tool. It can also be run manually to call the tool directly. */
    invoke(args: ToolArgs<typeof this.argsShape>, { signal, requestInfo }: ToolExecutionContext): Promise<CallToolResult>;
    /**
    ...
    constructor({ name, category, operationType, session, config, telemetry, elicitation, uiRegistry, }: ToolConstructorParams);
