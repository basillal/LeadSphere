...
class CreateIndexTool extends mongodbTool_js_1.MongoDBToolBase {
    constructor() {
        super(...arguments);
        this.filterFieldSchema = zod_1.z
            .object({
        ...
        this.vectorFieldSchema = zod_1.z
            .object({
...
`);
        this.autoEmbedFieldSchema = zod_1.z
            .object({
            type: zod_1.z.literal("autoEmbed"),
            path: zod_1.z.string().describe(`\
...
`),
            model: zod_1.z
                .enum(mongodbSchemas_js_1.modelsSupportingAutoEmbedIndexes)
