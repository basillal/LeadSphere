...
class ExportTool extends mongodbTool_js_1.MongoDBToolBase {
        ...
        this.argsShape = {
            ...
            exportTarget: zod_1.default
                ...
                zod_1.default.object({
                    ...
                    arguments: zod_1.default
                        .object((0, aggregate_js_1.getAggregateArgs)(this.isFeatureEnabled("search")))
    ...
    async execute({ database, collection, jsonExportFormat, exportTitle, exportTarget: target }, { signal }) {
        ...
        const exportName = `${new bson_1.ObjectId().toString()}.json`;
...
ExportTool.toolName = "export";
ExportTool.operationType = "read";
