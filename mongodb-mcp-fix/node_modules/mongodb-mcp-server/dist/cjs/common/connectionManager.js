...
exports.createMCPConnectionManager = exports.MCPConnectionManager = exports.ConnectionManager = exports.ConnectionStateConnected = exports.defaultDriverOptions = void 0;
...
class MCPConnectionManager extends ConnectionManager {
    ...
    async close() {
        try {
            ...
            this.logger.error({
                id: logger_js_1.LogId.mongodbDisconnectFailure,
...
const createMCPConnectionManager = ({ logger, deviceId, userConfig }) => {
