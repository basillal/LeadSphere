...
class Server {
    ...
    constructor({ session, mcpServer, userConfig, telemetry, connectionErrorHandler, elicitation, tools, uiRegistry, }) {
        ...
        this.toolConstructors = tools ?? index_js_1.AllTools;
    ...
    async connect(transport) {
        ...
        this.mcpServer.server.setRequestHandler(types_js_1.SetLevelRequestSchema, ({ params }) => {
            if (!logger_js_1.McpLogger.LOG_LEVELS.includes(params.level)) {
    ...
    async validateConfig() {
        ...
        if (this.userConfig.apiClientId && this.userConfig.apiClientSecret) {
            try {
                ...
                try {
                    ...
                    if (apiBaseUrl.protocol !== "https:") {
                        ...
                        this.session.logger.warning({
                            id: logger_js_1.LogId.atlasApiBaseUrlInsecure,
                            context: "server",
                            message,
                        });
                    }
                ...
                this.session.logger.warning({
                    id: logger_js_1.LogId.atlasCheckCredentials,
                    context: "server",
